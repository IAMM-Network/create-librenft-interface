...
export const FilterTextbox = () => {
  ...
  return (
    <form style={{ width: '100%' }}>
      <StyledInput className={'inputWithIcon'} htmlFor='search'>
        <div className='left-icon'>
          <svg width='21' height='22' viewBox='0 0 21 22' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <circle cx='8' cy='8' r='6.5' stroke='#4F4F4F' strokeWidth='3' />
            <path d='M12.7998 13.6001L19.1998 20.0001' stroke='#4F4F4F' strokeWidth='3' />
          </svg>
        </div>
