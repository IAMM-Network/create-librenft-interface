...
const Icon: React.FC<SvgProps> = props => (
  <Svg width='25' height='25' viewBox='0 0 25 25' fill='none' xmlns='http://www.w3.org/2000/svg'>
    ...
    <path
      d='M18.7502 18.6234C16.8831 16.7564 15.0117 14.885 13.1406 13.0139C13.923 13.0139 14.7203 13.0139 15.5369 13.0139C15.5369 10.7536 15.5369 8.50756 15.5369 6.25C16.6178 6.25 17.6794 6.25 18.7502 6.25C18.7502 10.3858 18.7502 14.5154 18.7502 18.6234Z'
      fill={props.fill}
    />
    <path
