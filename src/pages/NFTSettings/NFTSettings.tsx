    ...
    <>
      <Container>
        <Flex flexDirection='column' alignContent='center' paddingTop='104px' paddingBottom='100px'>
          ...
          <Flex flexDirection={'column'}>
            <Flex width={'100%'} alignItems={'flex-start'}>
              ...
              <Flex flexDirection={'column'} width={'100%'}>
                <OptionTitle style={{ marginBottom: '15px' }}>Transfer to</OptionTitle>
                <Flex flexDirection='column'>
                  <OptionRow>
            ...
            {Array(fractionalCount)
              ...
              .map((_, i) => (
                <Flex width={'100%'} marginTop={20} alignItems={'flex-start'}>
                  ...
                  <Flex flexDirection={'column'} width={'100%'}>
                    <OptionTitle style={{ marginBottom: '15px' }}>Fractional</OptionTitle>
                    <Flex flexDirection='column'>
                      <OptionRow>
                      ...
                      <OptionRow marginTop={10}>
                        ...
                        <Flex alignItems={'center'} style={{ width: '80px', position: 'relative' }}>
                          <InputBox style={{ textAlign: 'right', paddingRight: '25px' }} />
                          <OptionText
                            style={{
                              position: 'absolute',
                              right: '10px',
          ...
          <div style={{ cursor: 'pointer', marginTop: '20px' }} onClick={() => setFractionalCount(prev => prev + 1)}>
          ...
          <Flex marginTop={40} flexDirection={'column'}>
            <Flex width={'100%'} alignItems={'flex-start'}>
              ...
              <Flex flexDirection={'column'} width={'100%'}>
                <Flex justifyContent={'space-between'} alignItems={'center'} style={{ marginBottom: '15px' }}>
                  <OptionTitle>Rentable</OptionTitle>
                  <OptionText
                    style={{
                      display: 'flex',
                      gap: '5px',
                ...
                <Flex flexDirection='column'>
                  <OptionRow>
                    <OptionText>Input wallet address to whom you'll rent</OptionText>
                  </OptionRow>
                  <Flex style={{ marginLeft: '-20px' }} marginTop={10}>
                    <InputBox placeholder='0x...' />
                  </Flex>
                  ...
                  <Flex>
                    ...
                    {rentableFrom ? (
                      <>
                        <OptionInput onChange={e => setRentableFromValue(new Date(e.target.value))} type='datetime-local' />
                        <OptionText
                          style={{
                            marginRight: 30,
                            marginLeft: 10,
                      ...
                      <>
                        <OptionText onClick={() => setRentableFrom(true)} style={{ marginRight: 30 }}>
                  ...
                  <Flex>
                    ...
                    {rentableTo ? (
                      <>
                        <OptionInput onChange={e => setRentableToValue(new Date(e.target.value))} type='datetime-local' />
                        <OptionText
                          style={{
                            marginRight: 30,
                            marginLeft: 10,
                      ...
                      <>
                        <OptionText onClick={() => setRentableTo(true)} style={{ marginRight: 30 }}>
                  ...
                  <OptionRow>
                    ...
                    <Flex alignItems={'center'} style={{ width: '122px', position: 'relative' }}>
                      <InputBox style={{ textAlign: 'right', paddingRight: '50px' }} />
                      <IAMMIcon width={13} height={13} style={{ position: 'absolute', right: '20px' }} />
                    </Flex>
                  </OptionRow>
                  <OptionRow marginTop={20}>
                    <div></div>
                    <Flex alignItems={'center'} style={{ position: 'relative' }}>
                      <OptionText style={{ marginRight: '60px' }}>Daily: 10</OptionText>
                      <IAMMIcon width={13} height={13} style={{ position: 'absolute', right: '20px' }} />
                    </Flex>
                  </OptionRow>
                  <OptionRow marginTop={10}>
                    <div></div>
                    <Flex alignItems={'center'} style={{ position: 'relative' }}>
                      <OptionText style={{ marginRight: '60px' }}>Hourly: 0.416</OptionText>
                      <IAMMIcon width={13} height={13} style={{ position: 'absolute', right: '20px' }} />
                    </Flex>
                  </OptionRow>
                  <Divider style={{ marginLeft: '-20px', width: 'calc(100% + 20px)' }} />
          ...
          <Flex marginTop={40} flexDirection={'column'}>
            <Flex width={'100%'} alignItems={'flex-start'}>
              ...
              <Flex flexDirection={'column'} width={'100%'}>
                <Flex justifyContent={'space-between'} alignItems={'center'} style={{ marginBottom: '15px' }}>
                  <OptionTitle style={{ width: 'inherit' }}>Unlockable Content</OptionTitle>
                </Flex>
                <Flex flexDirection='column'>
                  <OptionRow>
                ...
                <Flex flexDirection={'column'} style={{ width: 'calc(100% + 20px)', marginLeft: '-20px' }}>
                  ...
                  <div style={{ cursor: 'pointer', marginTop: '20px' }} onClick={() => setFileCount(prev => prev + 1)}>
                    <CircleAddIcon width={24} height={24} />
                  </div>
                </Flex>
                  ...
                  {Array(linkCount)
                    ...
                    .map((_, i) => (
                      <Flex key={i} marginTop={10}>
                        <InputBox placeholder='https://' style={{ paddingLeft: '20px' }} />
                      </Flex>
                    ))}

                  <div style={{ cursor: 'pointer', marginTop: '20px' }} onClick={() => setLinkCount(prev => prev + 1)}>
                    <CircleAddIcon width={24} height={24} />
                  </div>
                </Flex>

                <OptionText style={{ marginTop: '30px' }}>Set rules (if any):</OptionText>
                <OptionText style={{ marginTop: '10px' }}>Set custom conditions as text for your holders</OptionText>
                ...
                <Flex flexDirection={'column'} style={{ width: 'calc(100% + 20px)', marginLeft: '-20px' }}>
                  ...
                  <OptionText style={{ marginTop: '10px', textAlign: 'center' }}>500 characters max.</OptionText>
                </Flex>

                <OptionText style={{ marginTop: '30px', marginBottom: '10px' }}>Set holding time</OptionText>
                <Flex flexDirection={'column'} style={{ width: 'calc(100% + 20px)', marginLeft: '-20px' }}>
                  <Flex alignItems={'center'}>
                    <Flex flexDirection={'column'} alignItems={'center'}>
                      <OptionText>Days</OptionText>
                      <InputBox type='number' placeholder='000' style={{ textAlign: 'center' }} />
                    </Flex>
                    ...
                    <Flex flexDirection={'column'} alignItems={'center'}>
                      ...
                      <InputBox type='number' placeholder='00' style={{ textAlign: 'center' }} />
                    </Flex>
                    <Flex style={{ marginInline: '5px', marginTop: '20px' }}>
                      <OptionText>:</OptionText>
                    </Flex>
            ...
            <Flex width={'100%'} alignItems={'flex-start'}>
              ...
              <Flex flexDirection={'column'} width={'100%'}>
                <Flex justifyContent={'space-between'}>
                  <OptionTitle style={{ marginBottom: '15px', width: 'inherit' }}>Whitelist</OptionTitle>
                </Flex>
                <Flex flexDirection='column'>
                  <OptionRow>
